...
export const metadata: Metadata = {
  title: "개인정보처리방침 | QR Studio",
  description: "QR Studio 개인정보처리방침. 수집하는 정보, 이용 목적, 보관 기간 등을 안내합니다.",
};
    ...
    <main className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <article className="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm p-8 sm:p-12">
        ...
        <p className="text-gray-700 mb-8 leading-relaxed">
          QR Studio(이하 &quot;서비스&quot;)는 이용자의 개인정보를 소중히 여기며,
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            ...
            <li>
              <strong>localStorage QR 생성 히스토리:</strong> 이용자가 생성한 QR코드의 설정 정보(QR 타입, 입력 데이터 등)가
              브라우저의 localStorage에 저장됩니다. 이 데이터는 서버로 전송되지 않으며,
              이용자의 브라우저 내에서만 보관됩니다. 브라우저 데이터를 삭제하면 함께 제거됩니다.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            ...
            <li>이용자 편의를 위한 QR코드 생성 히스토리 제공 (localStorage)</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-3 leading-relaxed">
            ...
            쿠키는 웹사이트 방문 시 브라우저에 저장되는 작은 텍스트 파일로, 방문 통계를 수집하는 데 활용됩니다.
          </p>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            ...
            <li>
              localStorage 데이터는 이용자가 브라우저 데이터를 삭제하거나 서비스 내에서 히스토리를 삭제할 때 파기됩니다.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            ...
            <li>브라우저의 개발자 도구 또는 설정에서 localStorage 데이터를 직접 삭제할 수 있습니다.</li>
