...
export const metadata: Metadata = {
  title: "이용약관 | 색상 도구",
  description: "색상 도구 서비스의 이용약관입니다.",
};
      ...
      <article className="mx-auto max-w-2xl rounded-xl border border-slate-200 bg-white p-6 md:p-10">
        ...
        <section className="mt-8 space-y-6 text-sm leading-relaxed text-slate-700">
          <div>
            ...
            <p className="mt-2">
              본 약관은 &ldquo;색상 도구&rdquo;(이하 &ldquo;서비스&rdquo;)의
              이용 조건 및 절차에 관한 사항을 정하는 것을 목적으로 합니다. 서비스는
              사용자에게 색상 변환, 팔레트 생성, 명도 대비 검사 등을 제공하는 무료 온라인 도구를 제공합니다.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-2 list-disc pl-5 space-y-2">
              ...
              <li>
                색상 변환 결과는 모니터 설정 등에 따라 실제 색상과 차이가 있을 수
                있습니다.
              </li>
              <li>
