...
export const metadata: Metadata = {
  ...
  description: "연봉 실수령액 계산기 서비스의 개인정보처리방침입니다.",
};
      ...
      <article className="mx-auto max-w-2xl rounded-xl border border-slate-200 bg-white p-6 md:p-10">
        ...
        <section className="mt-8 space-y-6 text-sm leading-relaxed text-slate-700">
          <div>
            ...
            <p className="mt-2">
              &ldquo;연봉 실수령액 계산기&rdquo;(이하 &ldquo;서비스&rdquo;)는 연봉 기반의
              세후 실수령액을 참고용으로 계산해 주는 무료 온라인 도구입니다. 서비스는
          ...
          <div>
            ...
            <p className="mt-2">
              서비스는 회원가입을 요구하지 않으며, 사용자가 입력하는 연봉 등의 계산
              데이터는 서버에 저장되지 않고 브라우저 내에서만 처리됩니다.
            </p>
            <p className="mt-2">
