...
export const metadata: Metadata = {
  title: "이용약관 | 대출이자 계산기",
  description: "대출이자 계산기 서비스의 이용약관입니다.",
};
      ...
      <article className="mx-auto max-w-2xl rounded-xl border border-slate-200 bg-white p-6 md:p-10">
        ...
        <section className="mt-8 space-y-6 text-sm leading-relaxed text-slate-700">
          <div>
            ...
            <p className="mt-2">
              본 약관은 &ldquo;대출이자 계산기&rdquo;(이하 &ldquo;서비스&rdquo;)의
              이용 조건 및 절차에 관한 사항을 정하는 것을 목적으로 합니다. 서비스는
              사용자에게 대출 상환액과 이자를 참고용으로 계산하는 무료 온라인 도구를 제공합니다.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-2 list-disc pl-5 space-y-2">
              ...
              <li>
                실제 대출 상환액은 금융기관별 이율, 수수료 등에 따라 달라질 수
                있습니다. 대출 관련 의사결정은 반드시 해당 금융기관에 확인하시기
                바랍니다.
              </li>
              <li>
